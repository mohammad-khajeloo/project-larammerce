...
@section('title')فروشگاه اینترنتی صنعت تاسیسات و پایپینگ، شیرآلات و اتصالات صنعتی
@endsection
                        ...
                        <div class="article-item">
                            <div class="pic">
                                <a href="{{$blog->getFrontUrl()}}">
                                    <img src="{{ImageService::getImage($blog, 'main')}}" alt="{{ $blog->title }}" class="img-fluid">
                                </a>
                            </div>
                            <div class="details">
