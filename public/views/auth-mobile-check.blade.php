...
@section('title')
    تایید مالکیت تلفن همراه - فروشگاه اینترنتی صنعت تاسیسات و پایپینگ، شیرآلات و اتصالات صنعتی
@endsection
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6 col-sm-12">
                    <div class="static-description">
                        ...
                        <a href="{{route('customer-auth.send-auth-confirm', ['mobile', $value])}}"
                           class="extra-link">
                            <i class="fa fa-long-arrow-alt-left"></i>ارسال مجدد کد
                        </a>
                        <a href="{{route('customer-auth.show-auth', 'email')}}" class="extra-link pull-left">
                            <i class="fa fa-long-arrow-alt-left"></i>ارسال کد از طریق ایمیل
                        </a>
